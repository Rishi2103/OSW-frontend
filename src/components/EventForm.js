...
function EventRegistrationForm() {
  ...
  const createEvent = async () => {
    ...
    try {
      ...
      formData1.append("timeZone", formData.timeZone);
      formData1.append("event_type", formData.event_type);
      ...
      formData1.append("limit", formData.limit);
      formData1.append("meet_link", formData.meet_link);
      formData1.append("socialmedia_links", formData.socialmedia_links);
      formData1.append("event_goals", formData.event_goals);
      formData1.append("event_tags", formData.event_tags);
      formData1.append("updatedTags", formData.updatedTags);
      formData1.append("speakers", formData.speakers);
      formData1.append("external_speaker", formData.external_speaker);
      formData1.append("event_description", formData.event_description);
      ...
      formData1.append("startTime", startDateTime);
      formData1.append("endTime", endDateTime);
      formData1.append("event_date", formData.event_date);
      ...
      const response = await fetch(`${hostname}/event/create-event`, {
        ...
        body: formData1, // Convert form data to JSON
      });
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    createEvent(); // Call the createEvent function to send the data to the server
  };
          ...
          {user && user.type === "admin" ? (
            ...
            <div>
              ...
              <div className="form-group">
                ...
                <textarea
                  name="custom_speakers"
                  value={formData.custom_speakers}
                  onChange={handleChange}
